  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="space-y-6 text-gray-800">
        <div>
          <h2 className="text-sm uppercase tracking-widest text-gray-500 mb-1">Email</h2>
          <p>hello@gabsport.com</p>
        </div>
        <div>
          <h2 className="text-sm uppercase tracking-widest text-gray-500 mb-1">Response Time</h2>
