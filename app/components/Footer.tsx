...
export default function Footer() {
  return (
    <footer className="border-t border-gray-100 dark:border-gray-800 mt-24">
      <div className="max-w-5xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500 dark:text-gray-300">
        <Image src="/logo.png" alt="gabsport" width={80} height={80} className="object-contain dark:hidden" />
        <Image src="/logo-white.png" alt="gabsport" width={80} height={80} className="object-contain hidden dark:block" />
